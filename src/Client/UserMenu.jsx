...
export const UserMenu=()=> {
    ...
    const data = product.map((product, index) => [product.name, product.location, product.costPerDay, [<Link key={index} className='btn btn-outline-primary mx-2' to={`/proposal/add/${product.id}`}>Оформить заявку</Link>]]);
